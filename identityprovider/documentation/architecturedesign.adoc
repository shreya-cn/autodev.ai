...
This document provides a comprehensive overview of the architecture of the Identity Provider system, designed for understanding by architects and senior developers.
...
"[project]/app/api/jira/related-tickets/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { stdout } = await execAsync(`cd "${workspaceRoot}" && python3 ai_ticket_suggester.py 2>&1`, {
            shell: '/bin/zsh',
            env: {
                ...process.env
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__86f2c3e9._.js.map
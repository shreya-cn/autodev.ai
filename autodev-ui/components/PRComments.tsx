...
export default function PRComments() {
  ...
  return (
    <div className="bg-gray-light rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 shadow-lg">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 mb-6 md:mb-8">
        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-dark">PR Feedback</h2>

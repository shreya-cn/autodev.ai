      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div 
            ...
            className="bg-gray-900 border border-green-500/20 rounded-xl p-8 cursor-pointer hover:border-green-500/40 transition-all hover:shadow-xl hover:shadow-green-500/10 group"
          >
